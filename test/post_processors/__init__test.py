...
from nerd_dictation.post_processors import post_processors, register_post_processor, process_text
from nerd_dictation.post_processors.full_sentence import full_sentence
...
def test_process_text_with_processors() -> None:
    ...
    assert process_text(test_words, options={"reverse": {"enabled": True}, "full_sentence": {"enabled": True}}) == "Words test"